...
extension DirectionsTableView: UITableViewDelegate {
  ...
  func setLabelBackgroundColor(label: UILabel, section: Int) {
    ...
    case 3:
        label.backgroundColor = UIColor.orangeColor().colorWithAlphaComponent(0.75)
    case 4:
        label.backgroundColor = UIColor.yellowColor().colorWithAlphaComponent(0.75)
    case 5:
        label.backgroundColor = UIColor.purpleColor().colorWithAlphaComponent(0.75)

    default:
      label.backgroundColor = UIColor.grayColor().colorWithAlphaComponent(0.75)
    }
  }
}
